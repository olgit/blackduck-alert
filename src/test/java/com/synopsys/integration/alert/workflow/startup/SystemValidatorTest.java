...
public class SystemValidatorTest {
    ...
    public void testValidate() {
        ...
        final SystemMessageInitializer systemValidator = new SystemMessageInitializer(List.of(), encryptionUtility, systemMessageUtility, userAccessor, defaultProxyManager);
    ...
    public void testvalidateBlackDuckProviderLocalhostURL() throws IOException {
        ...
        final TestBlackDuckProperties testGlobalProperties = new TestBlackDuckProperties(new Gson(), testAlertProperties, Mockito.mock(ConfigurationAccessor.class), defaultProxyManager);
        final SystemMessageUtility systemMessageUtility = Mockito.mock(SystemMessageUtility.class);
        final BlackDuckValidator blackDuckValidator = new BlackDuckValidator(testAlertProperties, testGlobalProperties, systemMessageUtility);
