...
public class AuditEntryActions {
    ...
    @Autowired
    public AuditEntryActions(final AuditUtility auditUtility, final NotificationManager notificationManager, final ConfigurationAccessor jobConfigReader, final ChannelEventManager eventManager,
